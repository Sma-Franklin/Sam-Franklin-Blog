...
## Direct Waves
In the last few months the line between the Merger and Ringdown has been blurred. New Theoretical research and observational signals suggest the existence of a new type of gravitational wave called a "direct wave". 
These direct waves are emitted right at the end of the merger as the black holes plunge towards one another. 
They are generated directly by orbital motion, but the signal is strongly altered by the spin and gravity of the remnant black hole meaning we can predict it theoretically.
These differ from the well understood quasi-normal modes (QNMs) of the ringdown signal, which are generated after merging without orbital motion. 
...
Since their signal is dominated by the physics of the remnant black hole we can understand them analytically. 
With this analytical understanding they provide an independent technique to measure the merged black holes mass and spin.
This can be combined with results found from analysing the inspiral and QNMs to produce a very precise result.

## References
Some of the images in this post were taken from the following papers.

{{< alert icon="arxiv" cardColor="#1f5e96" textColor="#f1faee" >}}
[Check out this paper for the observation of Direct Waves](https://arxiv.org/pdf/2510.01001)
{{< /alert >}}

{{< alert icon="arxiv" cardColor="#1f5e96" textColor="#f1faee" >}}
[Check out this paper for the theory behind Direct Waves](https://arxiv.org/pdf/2509.09165)
{{< /alert >}}
